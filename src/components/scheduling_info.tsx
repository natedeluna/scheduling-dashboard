...
export const SchedulingInfo = component$(() => {
    ...
    return (
        <>
            <section class="grid grid-flow-row grid-rows-10">
                ...
                <div id= "duration-menu"
                    class={["font-[600]", "text-[1rem]", "text-slate-800", "flex"," gap-3"," mt-5", "py-2","h-fit", "px-2"," rounded-md", !showDurationOptions.value ? ["active:bg-slate-200", "hover:bg-slate-100"]: "",  "transition", "items-center"]}
                ...
                <div class="flex gap-3 text-slate-800 py-2 px-2 cursor-pointer rounded-md hover:bg-emerald-100 active:bg-emerald-200 transition row-start-6">
